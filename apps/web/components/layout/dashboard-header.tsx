...
import { useLogoutUser, useUser } from "~/hooks/api/auth";
...
export function DashboardHeader() {
  ...
  const { logoutUserAsync, isPending } = useLogoutUser();
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden text-left md:block">
                ...
                <p className="mt-0.5 text-xs text-white/40">Creator</p>
              </div>
            </button>
                  ...
                  <div className="mb-2 rounded-2xl border border-white/5 bg-white/[0.03] p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-white/40">Creator Account</p>
                      </div>
                    </div>
                  </div>
